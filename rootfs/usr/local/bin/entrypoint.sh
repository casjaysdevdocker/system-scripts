...
# @@File             :  entrypoint.sh
# @@Description      :  entrypoint point for system-scripts
...
__heath_check() {
  ...
  start-system-scripts.sh healthcheck || status=$((status + 1))
...
HOSTNAME="${HOSTNAME:-casjaysdev-system-scripts}"
